...
Version  : 7.4.0
Release  : 4
URL      : https://files.pythonhosted.org/packages/ca/36/4e8693f6baa15daf5f75cbbe348de5f776b4892d98c10c6c71acc310a0fe/pysaml2-7.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ca/36/4e8693f6baa15daf5f75cbbe348de5f776b4892d98c10c6c71acc310a0fe/pysaml2-7.4.0.tar.gz
...
%prep
%setup -q -n pysaml2-7.4.0
cd %{_builddir}/pysaml2-7.4.0
pushd ..
cp -a pysaml2-7.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676418881
