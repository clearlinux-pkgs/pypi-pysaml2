...
Version  : 7.4.1
Release  : 5
URL      : https://files.pythonhosted.org/packages/c8/2a/9c0e8d66bf0c1aeddd560b08ee49c1625ab19ece4abc256503486bd81319/pysaml2-7.4.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/c8/2a/9c0e8d66bf0c1aeddd560b08ee49c1625ab19ece4abc256503486bd81319/pysaml2-7.4.1.tar.gz
...
%prep
%setup -q -n pysaml2-7.4.1
cd %{_builddir}/pysaml2-7.4.1
pushd ..
cp -a pysaml2-7.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677258889
